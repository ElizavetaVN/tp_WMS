...
using Application.Features.WarehouseFeatures.Commands;
...
namespace WebIdentity.Controllers
{
    ...
    public class WarehousesController : Controller
    {
        ...
        {
            var model = (await _mediator.Send(new GetAllWarehouseQuery()));
            return View(model);
        ...
        {
            var model = (await _mediator.Send(new GetWarehouseByIdQuery { Id = id }));
            return View(model);
        }
        /// <summary>
        ...
        {
            await _mediator.Send(new DeleteWarehouseByIdCommand { Id = id });
            return RedirectToActionPermanent("Index");
        }
